...
from model.model_pg import get_morpion_par_equipe , get_morpion_par_id , verif_cond_victoire , ajoute_journal
    ...
    if 'valider_deplacement' in POST :
        ...
        if not 'morpion_selectionne[]' in POST or not 'case_cible[]' in POST :
            ...
            if equipe1_active :
                ...
                SESSION['EQUIPE_1_ACTIVE'] = True
            REQUEST_VARS['equipe1_active'] = equipe1_active
            ajoute_journal(SESSION['CONNEXION'] , coord_1 , coord_2 ,tab , morpion_action ,None ,None ,equipe1_active) 
